...
export default function MedicinaGame() {
  ...
  return (
    <div className="min-h-screen relative" style={{ background: "linear-gradient(135deg,#082848 0%,#0c3a6b 60%,#082848 100%)" }}>
      ...
      <div className="sticky top-0 z-50 px-4 py-3" style={{ background: "rgba(8,40,72,0.92)", backdropFilter: "blur(12px)" }}>
        <div className="max-w-lg mx-auto flex items-center gap-3">
          <a href="/simular" className="text-white/50 hover:text-white transition text-lg">←</a>
          <span className="text-white font-bold flex-1">🏥 Medicina — ER Simulator</span>
