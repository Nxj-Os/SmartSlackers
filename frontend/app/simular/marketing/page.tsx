...
export default function MarketingGame() {
  ...
  return (
    <div className="min-h-screen relative" style={{ background: "linear-gradient(135deg,#2d0035 0%,#450050 60%,#2d0035 100%)" }}>
      ...
      <div className="sticky top-0 z-50 px-4 py-3" style={{ background: "rgba(45,0,53,0.92)", backdropFilter: "blur(12px)" }}>
        <div className="max-w-lg mx-auto flex items-center gap-3">
          <a href="/simular" className="text-white/50 hover:text-white transition text-lg">←</a>
          <span className="text-white font-bold flex-1">📣 Marketing — Agencia Digital</span>
