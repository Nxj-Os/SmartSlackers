...
export default function GastronomiaGame() {
  ...
  return (
    <div className="min-h-screen relative" style={{ background: "linear-gradient(135deg,#3d1500 0%,#5c2000 60%,#3d1500 100%)" }}>
      ...
      <div className="sticky top-0 z-50 px-4 py-3" style={{ background: "rgba(61,21,0,0.92)", backdropFilter: "blur(12px)" }}>
        <div className="max-w-lg mx-auto flex items-center gap-3">
          <a href="/simular" className="text-white/50 hover:text-white transition text-lg">←</a>
          <span className="text-white font-bold flex-1">👨‍🍳 Gastronomía — Restaurante Estrella</span>
